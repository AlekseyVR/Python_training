...
@given('a group with <name_group>, <logo_group> and <footer_group>', target_fixture="new_group")
def new_group(name_group, logo_group, footer_group):
    return Group(name_group=name_group, logo_group=logo_group, footer_group=footer_group)
...
def non_empty_group_list(db, app):
    if len(db.get_group_list()) == 0:
        app.group.create(Group(name_group="bddGroup"))
    return db.get_group_list()
